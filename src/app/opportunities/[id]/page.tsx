    ...
    <main className="min-h-screen bg-background text-white">
      <div className="mx-auto max-w-6xl px-4 py-8 lg:px-8">
        <div className="mb-6 flex items-center gap-4">
          <Link
            href="/opportunities"
            className="text-sm text-primary transition hover:text-indigo-300"
          >
          ...
          <div className="mt-8 space-y-4">
            <div className="rounded-3xl border border-white/10 bg-background/80 p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-muted">
                ...
                {opportunity.category.toLowerCase()} and modern workflows. It is
                well suited for founders who want to build differentiated
                tooling with strong adoption potential.
              </p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-background/80 p-6">
              <h2 className="flex items-center gap-2 text-xl font-semibold text-white">
                <Sparkles className="h-5 w-5 text-primary" /> Related
                Opportunities
              </h2>
